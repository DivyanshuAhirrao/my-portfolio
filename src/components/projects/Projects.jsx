...
const Projects = () => {
  ...
  return (
    <div id="projects" className="w-[100%] py-12 flex flex-col justify-center items-center">
      ...
      <p className="text-center text-gray-500 text-[16px] w-[70%] text-justify border-b-2 border-dotted py-4 border-emerald-600">
        Here you will find some of the personal and clients projects that I
        created with each project containing its own case study.
      </p>
      <section data-aos="zoom-in-up" className="w-[80%] flex flex-wrap justify-around items-center">
        ...
        <aside className="xs:w-[80%] sm:min-w-[600px] md:w-[50%] h-[100%] relative top-4">
          <div className="pt-12 flex flex-col gap-2">
            <h1 className="uppercase font-mono lg:text-[3vw] xs:text-[20px] hover:underline hover:underline-offset-8 transition-all duration-300 cursor-pointer">
              Portfolio
            </h1>
            <p>
          ...
          <a href="https://portfolio-trial3.netlify.app" target="_blank">
      ...
      <section data-aos="zoom-in-up" className="w-[80%] flex flex-wrap-reverse justify-around items-center">
        <aside className="xs:w-[80%] sm:min-w-[600px] md:w-[50%] h-[100%] relative top-4">
          <div className="pt-12 flex flex-col gap-2">
            <h1 className="uppercase font-mono lg:text-[3vw] xs:text-[20px] hover:underline hover:underline-offset-8 transition-all duration-300 cursor-pointer">
              Shopper-Sparrow
